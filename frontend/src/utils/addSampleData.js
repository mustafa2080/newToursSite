...
const sampleHotel = {
  ...
  searchKeywords: [
    'luxury', 'beach', 'resort', 'maldives', 'ocean', 'overwater', 'bungalow',
    'spa', 'diving', 'honeymoon', 'romantic', 'villa', 'infinity pool',
    'private beach', 'water sports', 'fine dining', 'wellness'
  ],
...
const sampleTrip = {
  ...
  // Search keywords for better search functionality
  searchKeywords: [
    'safari', 'wildlife', 'africa', 'kenya', 'masai mara', 'adventure',
    'lions', 'elephants', 'big five', 'nature', 'photography', 'camping',
    'guide', 'national reserve', 'animals', 'game drive'
  ],
