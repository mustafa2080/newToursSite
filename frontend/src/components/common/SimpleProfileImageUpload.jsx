...
const SimpleProfileImageUpload = ({ 
  currentImage, 
  onImageUpdate, 
  size = 'large',
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      // Upload new image - simple approach without deletion
  ...
  const handleRemoveImage = async () => {
    ...
    setUploading(true);
    try {
      // Simply update user profile - don't try to delete from storage
      const updateResult = await updateProfile({
        profileImage: null
      });
...
export default SimpleProfileImageUpload;
