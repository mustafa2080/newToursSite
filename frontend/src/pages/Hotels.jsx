                      ...
                      <Link to={`/hotels/${hotel.slug}`}>
                        <Card hover padding="none" className="overflow-hidden h-full">
                          <div className="relative">
                            <img
                              src={hotel.mainImage || hotel.main_image || hotel.image || hotel.photo || `https://picsum.photos/500/300?random=${1200 + index}`}
                              alt={hotel.name}
                              className="w-full h-48 object-cover"
                              onError={(e) => {
                                console.log('🖼️ Hotel image failed to load:', e.target.src);
                                e.target.src = `https://picsum.photos/500/300?random=${1200 + index}`;
                              }}
                            />
