                ...
                <Link to={`/trips/${trip.slug}`}>
                  <Card hover padding="none" className="overflow-hidden">
                    <div className="relative">
                      <img
                        src={trip.mainImage || trip.main_image || trip.image || trip.photo || `https://picsum.photos/500/300?random=${800 + index}`}
                        alt={trip.title}
              ...
              >
                <Link to={`/hotels/${hotel.slug}`}>
                  <Card hover padding="none" className="overflow-hidden">
                    <div className="relative">
                      <img
                        src={hotel.mainImage || hotel.main_image || hotel.image || hotel.photo || `https://picsum.photos/500/300?random=${900 + index}`}
                        alt={hotel.name}
                        className="w-full h-48 object-cover"
                        onError={(e) => {
