...
const About = () => {
  ...
  const loadContent = async () => {
    try {
      setLoading(true);
      console.log('🔄 Loading about content from Firebase...');
      ...
      if (result.success) {
        ...
        console.log('✅ About content loaded successfully:', result.content);
      } else {
      ...
      setContent({
        ...
        mission: 'To provide exceptional travel experiences that inspire and educate.',
        vision: 'To be the world\'s most trusted travel companion.',
        values: ['Customer First', 'Sustainable Tourism', 'Cultural Respect'],
        team: [],
        hero_image: 'https://images.unsplash.com/photo-1488646953014-85cb44e25828?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80',
      });
    } finally {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative h-96 md:h-[500px] overflow-hidden">
        <img
          src={content?.hero_image || 'https://images.unsplash.com/photo-1488646953014-85cb44e25828?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80'}
          alt="About Us"
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="text-center text-white max-w-4xl mx-auto px-4">
            ...
            >
              {content?.title || 'About Premium Tours'}
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              {content?.subtitle || 'Your Gateway to Extraordinary Adventures'}
            </motion.p>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-4xl mx-auto leading-relaxed">
            {content?.description || 'We are passionate about creating unforgettable travel experiences that connect you with the world\'s most beautiful destinations.'}
          </p>
        </motion.div>
        ...
        >
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-bold text-blue-600 mb-2">
              {(content?.stats?.years_experience || 15)}+
            </div>
            <div className="text-gray-600 text-sm">Years Experience</div>
          </div>
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-bold text-blue-600 mb-2">
              {(content?.stats?.destinations || 150)}+
            </div>
            <div className="text-gray-600 text-sm">Destinations</div>
          </div>
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-bold text-blue-600 mb-2">
              {(content?.stats?.happy_customers || 25000).toLocaleString()}+
            </div>
            <div className="text-gray-600 text-sm">Happy Customers</div>
          </div>
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-bold text-blue-600 mb-2">
              {(content?.stats?.team_members || 50)}+
            </div>
            <div className="text-gray-600 text-sm">Team Members</div>
          </div>
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-bold text-blue-600 mb-2">
              {(content?.stats?.countries || 45)}+
            </div>
            <div className="text-gray-600 text-sm">Countries</div>
          </div>
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-bold text-blue-600 mb-2">
              {(content?.stats?.awards || 12)}+
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                {content?.story || 'Founded in 2009 by a group of passionate travelers, Premium Tours began as a small dream to share the world\'s hidden gems with fellow adventurers.'}
              </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
          ...
          >
            <Card className="p-8 h-full">
              ...
              <p className="text-gray-600 leading-relaxed">
                {content?.mission || 'To provide exceptional travel experiences that inspire, educate, and create lasting memories while promoting sustainable tourism.'}
              </p>
            </Card>
          </motion.div>
          ...
          >
            <Card className="p-8 h-full">
              ...
              <p className="text-gray-600 leading-relaxed">
                {content?.vision || 'To be the world\'s most trusted travel companion, making extraordinary journeys accessible to everyone.'}
              </p>
            </Card>
          </motion.div>
        </div>
          ...
          <div className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl p-8 md:p-12 text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
              <div className="text-center">
                ...
                <p className="text-blue-100">{content?.contact?.phone || '+1 (555) 123-4567'}</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-blue-100">{content?.contact?.email || 'info@premiumtours.com'}</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-blue-100 text-sm">{content?.contact?.address || '123 Travel Street, Adventure City, AC 12345'}</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-blue-100 text-sm">{content?.contact?.hours || 'Mon-Fri: 9AM-6PM, Sat: 10AM-4PM'}</p>
              </div>
            </div>
