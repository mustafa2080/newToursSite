...
import { collection, getDocs, query, orderBy, where, updateDoc, doc, addDoc } from 'firebase/firestore';
...
const SecurityManagement = () => {
  ...
  const loadSecurityData = async () => {
    try {
      ...
      // Load security settings from Firebase or use defaults
      ...
      try {
        ...
        if (!settingsSnapshot.empty) {
          ...
          securitySettings = { ...securitySettings, ...settingsDoc.data().security };
        }
      } catch (error) {
                  ...
                  <Button
                    ...
                    onClick={() => {
                      const newSettings = {
                        ...
                        twoFactorEnabled: !securityData.securitySettings.twoFactorEnabled
                      };
                      saveSecuritySettings(newSettings);
                    }}
                  >
                    {securityData.securitySettings.twoFactorEnabled ? 'Disable' : 'Enable'}
                  </Button>
                </div>
                <div className="flex items-center justify-between">
                  <div>
            ...
            <Card className="p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <input
                    type="number"
                    value={securityData.securitySettings.passwordPolicy?.minLength || 8}
                    onChange={(e) => {
                      const newSettings = {
                        ...securityData.securitySettings,
                        passwordPolicy: {
                          ...securityData.securitySettings.passwordPolicy,
                ...
                <div className="flex items-center justify-between">
                  ...
                  <input
                    type="checkbox"
                    checked={securityData.securitySettings.passwordPolicy?.requireUppercase || false}
                    onChange={(e) => {
                      const newSettings = {
                        ...securityData.securitySettings,
                        passwordPolicy: {
                ...
                <div className="flex items-center justify-between">
                  ...
                  <input
                    type="checkbox"
                    checked={securityData.securitySettings.passwordPolicy?.requireNumbers || false}
                    onChange={(e) => {
                      const newSettings = {
                        ...securityData.securitySettings,
                        passwordPolicy: {
                ...
                <div className="flex items-center justify-between">
                  ...
                  <input
                    type="checkbox"
                    checked={securityData.securitySettings.passwordPolicy?.requireSymbols || false}
                    onChange={(e) => {
                      const newSettings = {
                        ...securityData.securitySettings,
                        passwordPolicy: {
                ...
                <div className="flex items-center justify-between">
                  ...
                  <input
                    type="number"
                    value={securityData.securitySettings.passwordPolicy?.maxAge || 90}
                    onChange={(e) => {
                      const newSettings = {
                        ...securityData.securitySettings,
                        passwordPolicy: {
